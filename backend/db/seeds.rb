...
load "#{SEED_DIR}/reviews/review_comments.rb"
load "#{SEED_DIR}/reviews/reviews.rb"
load "#{SEED_DIR}/banner/banner.rb"
load "#{SEED_DIR}/collection/collection.rb"
load "#{SEED_DIR}/book_collection/book_collection.rb"
